...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Por favor atualizar este campo.",
		email: "Informe um endereço de e-mail válido.",
		url: "Informe uma URL válida.",
		date: "Informe uma data válida.",
		dateISO: "Informe uma data (ISO) válida.",
		number: "Informe um número válido.",
		digits: "Por favor informe somente os números.",
		creditcard: "Por favor informe um número de cartão de crédito válido.",
		equalTo: "Repita os dados novamente.",
		accept: "A extensão informada não é aceita.",
